"""AI Governance Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="AI governance and compliance agent that manages model registries, tracks model lineage, enforces responsible AI policies, conducts bias audits, and generates compliance documentation for regulatory frameworks.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
